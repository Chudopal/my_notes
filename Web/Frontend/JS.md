...
+ **`JSON.parse`** - для декодирования JSON-строки обратно а объекты:
  ```javascript
...
+ Запросы XMLHttpRequest:
  ...
  4. Слушать события на xhr, чтобы получить ответ. Три наиболее используемых события:
    ...
    - **`progress`** – происходит периодически во время загрузки ответа, сообщает о прогрессе. 
      ...
      ```
    При удачной загрузке ответа можно получить из него различные данные, запрашивая у него свойства:
